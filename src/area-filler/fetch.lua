...
print("Fetching Area Filler program from " .. repository .. " repository...")

FetchRepository.fetch_files({
    "area-filler/area-filler.lua",
    "area-filler/fetch.lua",
    "area-filler/startup.lua"
}, repository)

print("Area Filler program fetched successfully.")
